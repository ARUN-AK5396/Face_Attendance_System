...
imgDaniel = face_recognition.load_image_file('ImagesAttendance/Daniel.jpg')
imgDaniel = cv2.cvtColor(imgDaniel, cv2.COLOR_BGR2RGB)
imgTest = face_recognition.load_image_file('ImagesAttendance/Rishu.jpg')
...
cv2.imshow('Elon Musk', imgDaniel)
